const USER_ERROR_MESSAGES = {
  ...
  INVALID_COLOR: 'Choose a valid drawing color.',
  INVALID_STROKE_WIDTH: 'Choose a valid brush size.',
  INVALID_POINT: 'That mark could not be drawn.',
  INVALID_POINT_BATCH: 'That mark could not be drawn.',
  INVALID_POINT_COUNT: 'That mark is too large.',
  ...
  INVALID_PLAYTEST_DURATION: 'Choose a valid playtest duration.',
  PLAYTEST_ALREADY_RUNNING: 'A playtest is already running for this room.',
  PLAYTEST_NOT_FOUND: 'No active playtest was found.',
  STROKE_NOT_FOUND: 'That mark could not be found.',
  NOT_STROKE_AUTHOR: 'You can only change your own marks.',
  STROKE_FINISHED: 'That mark is already finished.',
  STROKE_OUT_OF_SYNC: 'That mark fell out of sync. Try drawing it again.',
  STROKE_POINT_LIMIT: 'That mark is too long. Start a new one.',
