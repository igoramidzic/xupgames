...
export type AppErrorCode =
  ...
  | 'MINI_GAMES_IN_PROGRESS'
  | 'MINI_GAMES_NOT_RUNNING'
  | 'MINI_GAMES_ALREADY_SUBMITTED'
  | 'INVALID_MINI_GAMES_CONFIGURATION'
  | 'INVALID_MINI_GAME_SUBMISSION'
