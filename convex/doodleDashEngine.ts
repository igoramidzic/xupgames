...
export const DOODLE_DASH_MAX_STROKE_POINTS = 4_096;
export const DOODLE_DASH_MAX_LIVE_CHUNK_POINTS = 128;
export const DOODLE_DASH_MAX_LIVE_CHUNKS_PER_ACTION = 1_500;
export const DOODLE_DASH_MAX_VISIBLE_LIVE_CHUNKS = 16;
